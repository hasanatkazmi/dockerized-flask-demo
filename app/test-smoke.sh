...
# docker-compose has standard container naming so this container should be named plangridassignment_app_1
docker exec plangridassignment_app_1 cat /app/plangrid.log | grep xyz
